...
export default function Register({show, onHide, setShowRegister, setShowLogin}) {
      ...
      <Modal.Body className="col py-1 m-1">
        <Form onSubmit={handleOnSubmit}>
          ...
          <Form.Group className="mb" controlId="formBasicPassword">
            <Form.Label></Form.Label>
            <Form.Control
            onChange={(e) => setState({...userData, password: e.target.value})}
              className="form-control bg-danger bg-opacity-10"
              style={{
                height: "50px",
                borderColor: "#BD0707",
          ...
          <Form.Group className="mb" controlId="formBasicPassword">
            <Form.Label></Form.Label>
            <Form.Control
            onChange={(e) => setState({ ...userData, fullname: e.target.value})}
              className="form-control bg-danger bg-opacity-10"
              style={{
                height: "50px",
                borderColor: "#BD0707",
